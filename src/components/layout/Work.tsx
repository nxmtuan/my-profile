        ...
        <div id="works" className="work-wrapper flex mt-10 mb-10 justify-center items-center max-sm:ml-3 max-sm:mr-3">
            <div className="container flex flex-col justify-center items-center gap-5 w-full h-5/6">
                <div className="work-block flex gap-5 w-full h-fit">
                    <div className="work-block-title flex w-11/12 h-full font-bold text-3xl 2xl:text-4xl text-gray-700 bg-white rounded-xl p-7 items-center justify-center select-none">
                        MY EXPERIENCE
                    </div>
                ...
                <div className="work-block-content flex items-center w-full h-fit bg-white p-10 pl-20 pr-20 rounded-xl hover:shadow-2xl transition duration-500 max-sm:pl-10 max-sm:pr-10">
