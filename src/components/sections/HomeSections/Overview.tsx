...
export default function Overview() {
    return (
        <div className="block-page-left flex flex-col gap-5 w-1/4 h-full p-5 rounded-xl bg-white">
            <div className="block-page-left-top h-1/2 flex flex-col justify-center items-center gap-2 overflow-visible">
                ...
                <div className="social flex justify-center items-center gap-3">
                    <Link href="https://www.linkedin.com/in/minh-tuan-nguyen-xuan/">
                        <div className="linkedin flex justify-center items-center w-10 h-10 cursor-pointer bg-slate-200 rounded-lg">
                            <FontAwesomeIcon icon={faLinkedin} className="w-5 h-5 text-sky-700" />
                        </div>
                    </Link>
                    <Link href="https://github.com/tuannguyen2002">
                        <div className="github flex justify-center items-center w-10 h-10 cursor-pointer bg-slate-200 rounded-lg">
                            <FontAwesomeIcon icon={faGithub} className="w-5 h-5 text-black" />
                        </div>
                    </Link>
                    <Link href="https://zalo.me/0359146876">
                        <div className="zalo flex justify-center items-center w-10 h-10 cursor-pointer bg-slate-200 rounded-lg">
                            <FontAwesomeIcon icon={faZ} className="w-5 h-5 text-cyan-500" />
                        </div>
                    </Link>
                    <Link href="https://t.me/nx_minhtuan">
                        <div className="telegram flex justify-center items-center w-10 h-10 cursor-pointer bg-slate-200 rounded-lg">
            ...
            <div className="block-page-left-bottom h-1/2 flex flex-col gap-3 p-5 bg-slate-100 rounded-lg">
                ...
                <div className="block-page-left-bottom-4 flex justify-center items-end h-1/4">
                    <a
                        className="block-page-left-bottom-1-4 flex justify-center items-center gap-3 h-3/4 w-4/5 rounded-full cursor-pointer bg-gradient-to-r from-teal-400 to-blue-500"
