...
export default function Project2() {
    return (
        <div className="project-item-2 w-full h-full p-7 bg-blue-100 rounded-xl hover:shadow-2xl transition duration-500 dark:bg-neutral-700">
            <ol className="relative border-s-2 border-white dark:border-gray-300">
                <li className="ms-6">
                    <span className="absolute flex items-center justify-center w-6 h-6 bg-white rounded-full -start-3 ring-8 ring-blue-100 dark:ring-neutral-700 dark:bg-gray-300">
                        <FontAwesomeIcon icon={faTiktok} className="w-3 h-3 text-blue-800 dark:text-blue-800" />
                    </span>
