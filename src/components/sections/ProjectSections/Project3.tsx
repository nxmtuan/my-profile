...
export default function Project3() {
    return (
        <div className="project-item-3 w-full h-full p-7 bg-violet-100 rounded-xl hover:shadow-2xl transition duration-500 dark:bg-neutral-700">
            <ol className="relative border-s-2 border-white dark:border-gray-300">
                <li className="ms-6">
                    <span className="absolute flex items-center justify-center w-6 h-6 bg-white rounded-full -start-3 ring-8 ring-violet-100 dark:ring-neutral-700 dark:bg-gray-300">
                        <FontAwesomeIcon icon={faBookAtlas} className="w-3 h-3 text-blue-800 dark:text-blue-700" />
                    </span>
